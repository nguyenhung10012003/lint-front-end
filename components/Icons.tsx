...
export const Icons = {
  ...
  facebook: (props: IconProps) => (
    <svg viewBox="0 0 128 128" {...props}>
      ...
      <path fill="#fff"
            d="M86.48 123.17V77.34h15.38l2.3-17.86H86.48v-11.4c0-5.17 1.44-8.7 8.85-8.7h9.46v-16A126.56 126.56 0 0091 22.7c-13.62 0-23 8.3-23 23.61v13.17H52.62v17.86H68v45.83z"></path>
    </svg>
  ),

  home: (props: IconProps) => (
    props.variant === 'solid' ? <HomeIcon {...props}/> : <HomeIconOutline {...props}/>
  ),

  message: (props: IconProps) => (
    props.variant === 'solid' ? <ChatBubbleOvalLeftIcon {...props}/> : <ChatBubbleOvalLeftIconOutline {...props}/>
  ),
  ...
  notification: (props: IconProps) => (
    props.variant === 'solid' ? <BellIcon {...props}/> : <BellIconOutline {...props}/>
  ),
  ...
  profile: (props: IconProps) => (
    props.variant === 'solid' ? <UserIcon {...props}/> : <UserIconOutline {...props}/>
  ),
